package pl.databucket.api.tests.client;
...
import pl.databucket.api.tests.model.*;
import pl.databucket.api.tests.utils.Log;
...
public class Bucket {
    ...
    public RequestResponse insertData(Data data) {
        ...
        try {
            ...
            Log.requestResponseStep(requestResponse, "Insert data");
        }
    ...
    public RequestResponse insertMultiData(List<? extends Data> dataList) {
        ...
        try {
            ...
            requestResponse.setResponseDuration(System.currentTimeMillis() - start);
            Log.requestResponseStep(requestResponse, "Insert multi data");
        }
    ...
    public RequestResponse reserveData(Rules rules, boolean random) {
        ...
        try {
            ...
            requestResponse.setResponseDuration(System.currentTimeMillis()-start);
            Log.requestResponseStep(requestResponse, "Reserve data");
        }
    ...
    public RequestResponse updateData(Data data) {
        ...
        try {
            ...
            requestResponse.setResponseDuration(System.currentTimeMillis()-start);
            Log.requestResponseStep(requestResponse, "Update data");
        }
    ...
    public RequestResponse deleteData(Data data) {
        ...
        try {
            ...
            requestResponse.setResponseDuration(System.currentTimeMillis()-start);
            Log.requestResponseStep(requestResponse, "Delete data");
        }
    ...
    public static Data strToData(String dataStr) {
        return jsonToData(gson.fromJson(dataStr, Map.class));
    }

    public static Data jsonToData(Map<String, Object> jsonObj) {
        Long id = null;
        Integer tagId = null;
    ...
    public static Data customJsonToData(Map<String, Object> customJsonObj) {
        Long id = null;
        Integer tagId = null;
        Boolean reserved = null;
        String owner = null;
